...
// SVG Icons
const IcoBack = () => <svg width="20" height="20" viewBox="0 0 24 24" fill="none" stroke="rgba(240,234,248,0.5)" strokeWidth="2" strokeLinecap="round" strokeLinejoin="round"><polyline points="15 18 9 12 15 6"/></svg>;
const IcoGear = () => <svg width="20" height="20" viewBox="0 0 24 24" fill="none" stroke="rgba(240,234,248,0.5)" strokeWidth="2" strokeLinecap="round" strokeLinejoin="round"><circle cx="12" cy="12" r="3"/><path d="M19.4 15a1.65 1.65 0 0 0 .33 1.82l.06.06a2 2 0 0 1-2.83 2.83l-.06-.06a1.65 1.65 0 0 0-1.82-.33 1.65 1.65 0 0 0-1 1.51V21a2 2 0 0 1-4 0v-.09A1.65 1.65 0 0 0 9 19.4a1.65 1.65 0 0 0-1.82.33l-.06.06a2 2 0 0 1-2.83-2.83l.06-.06A1.65 1.65 0 0 0 4.68 15a1.65 1.65 0 0 0-1.51-1H3a2 2 0 0 1 0-4h.09A1.65 1.65 0 0 0 4.6 9a1.65 1.65 0 0 0-.33-1.82l-.06-.06a2 2 0 0 1 2.83-2.83l.06.06A1.65 1.65 0 0 0 9 4.68a1.65 1.65 0 0 0 1-1.51V3a2 2 0 0 1 4 0v.09a1.65 1.65 0 0 0 1 1.51 1.65 1.65 0 0 0 1.82-.33l.06-.06a2 2 0 0 1 2.83 2.83l-.06.06A1.65 1.65 0 0 0 19.4 9a1.65 1.65 0 0 0 1.51 1H21a2 2 0 0 1 0 4h-.09a1.65 1.65 0 0 0-1.51 1z"/></svg>;
...
const IcoSpeaker = ({ muted }) => muted
  ? <svg width="18" height="18" viewBox="0 0 24 24" fill="none" stroke="rgba(240,234,248,0.5)" strokeWidth="2" strokeLinecap="round" strokeLinejoin="round"><polygon points="11 5 6 9 2 9 2 15 6 15 11 19 11 5"/><line x1="23" y1="9" x2="17" y2="15"/><line x1="17" y1="9" x2="23" y2="15"/></svg>
  : <svg width="18" height="18" viewBox="0 0 24 24" fill="none" stroke="rgba(240,234,248,0.5)" strokeWidth="2" strokeLinecap="round" strokeLinejoin="round"><polygon points="11 5 6 9 2 9 2 15 6 15 11 19 11 5"/><path d="M19.07 4.93a10 10 0 0 1 0 14.14"/><path d="M15.54 8.46a5 5 0 0 1 0 7.07"/></svg>;
...
const IcoImage = () => <svg width="18" height="18" viewBox="0 0 24 24" fill="none" stroke="rgba(240,234,248,0.5)" strokeWidth="2" strokeLinecap="round" strokeLinejoin="round"><rect x="3" y="3" width="18" height="18" rx="2"/><circle cx="8.5" cy="8.5" r="1.5"/><polyline points="21 15 16 10 5 21"/></svg>;
const IcoPlus = () => <svg width="20" height="20" viewBox="0 0 24 24" fill="none" stroke="rgba(240,234,248,0.5)" strokeWidth="2.5" strokeLinecap="round"><line x1="12" y1="5" x2="12" y2="19"/><line x1="5" y1="12" x2="19" y2="12"/></svg>;
const IcoCopy = () => <svg width="14" height="14" viewBox="0 0 24 24" fill="none" stroke="rgba(240,234,248,0.5)" strokeWidth="2" strokeLinecap="round" strokeLinejoin="round"><rect x="9" y="9" width="13" height="13" rx="2"/><path d="M5 15H4a2 2 0 0 1-2-2V4a2 2 0 0 1 2-2h9a2 2 0 0 1 2 2v1"/></svg>;
function IcoKey() {
  return (
    <svg width="20" height="20" viewBox="0 0 24 24" fill="none" stroke="rgba(240,234,248,0.5)" strokeWidth="2" strokeLinecap="round" strokeLinejoin="round">
...
const [activeEnhance, setActiveEnhance] = useState(() => ls("echo_active_enhance", null));
  ...
  const GF = `@import url('https://fonts.googleapis.com/css2?family=Playfair+Display:wght@400;700&family=Lato:wght@300;400&display=swap');*{box-sizing:border-box;margin:0;padding:0}body{background:#0d0d16}input,textarea{color:#f0eaf8!important;background:rgba(255,255,255,0.06)!important;border-color:rgba(255,255,255,0.1)!important}input::placeholder,textarea::placeholder{color:rgba(240,234,248,0.3)!important}`;
  const pf = { fontFamily:"'Playfair Display',serif" };
  const lf = { fontFamily:"'Lato',sans-serif" };
  const BG = { background:`radial-gradient(ellipse at 20% 20%,${pal.b}28 0%,transparent 55%),radial-gradient(ellipse at 80% 80%,${pal.c}20 0%,transparent 55%),linear-gradient(160deg,#0d0d16,#12121e,#0f0f1a)`, minHeight:"100vh" };
  const glass = { background:"rgba(255,255,255,0.05)", backdropFilter:"blur(20px)", WebkitBackdropFilter:"blur(20px)", border:"1px solid rgba(255,255,255,0.08)", borderRadius:18 };
  const neuCard = { background:"#13131f", borderRadius:18, boxShadow:"6px 6px 16px rgba(0,0,0,0.55),-3px -3px 10px rgba(255,255,255,0.03)", border:"1px solid rgba(255,255,255,0.06)" };
...
// TC Screen
    ...
    <div style={{ ...BG,...lf,display:"flex",alignItems:"center",justifyContent:"center",padding:28 }}>
      ...
      <div style={{ maxWidth:340,width:"100%" }}>
        <div style={{ textAlign:"center",marginBottom:24 }}>
          ...
          <h2 style={{ ...pf,fontSize:22,color:"#f0eaf8" }}>Before you meet {aiName}</h2>
          <p style={{ fontSize:12,color:"rgba(240,234,248,0.5)",marginTop:6 }}>Please read and accept our terms</p>
        </div>
        <div style={{ background:"rgba(255,255,255,0.05)",backdropFilter:"blur(20px)",WebkitBackdropFilter:"blur(20px)",borderRadius:16,padding:18,border:"1px solid rgba(255,255,255,0.08)",fontSize:12,color:"rgba(240,234,248,0.75)",lineHeight:1.9,marginBottom:20,boxShadow:"inset 0 1px 0 rgba(255,255,255,0.06)" }}>
          <p style={{ ...pf,fontWeight:"bold",marginBottom:8,color:"#f0eaf8" }}>Terms & Conditions — {aiName} by Luminar Inc</p>
        ...
        <p style={{ textAlign:"center",fontSize:10,color:"rgba(240,234,248,0.25)",marginTop:12,letterSpacing:2 }}>{aiName.toUpperCase()} BY LUMINAR INC</p>
      </div>
    </div>
  );
    ...
    <div style={{ ...BG,...lf,display:"flex",flexDirection:"column",alignItems:"center",justifyContent:"center",padding:24,minHeight:"100vh" }}>
      ...
      <div style={{ textAlign:"center",maxWidth:340,width:"100%" }}>
        ...
        <div style={{ marginTop:28 }}>
          <h1 style={{ ...pf,fontSize:44,fontWeight:700,color:"#f0eaf8",letterSpacing:2 }}>{aiName}</h1>
          <p style={{ fontSize:12,color:`${pal.b}cc`,letterSpacing:3,textTransform:"uppercase",marginTop:4 }}>by Luminar Inc</p>
        </div>
        <p style={{ ...pf,fontSize:22,color:"#f0eaf8",marginTop:20,lineHeight:1.5 }}>
          {userName ? `${getGreeting()}, ${userName}! ${MOOD_EMOJI[emotion]}` : `How can I help you today?`}
        </p>
        <p style={{ color:"rgba(240,234,248,0.5)",fontSize:13,marginTop:10,lineHeight:1.7 }}>Your personal AI — she learns from you, grows with you, remembers you.</p>
        ...
        <button onClick={()=>setScreen("settings")} style={{ marginTop:14,background:"none",border:"none",color:"rgba(240,234,248,0.5)",fontSize:13,cursor:"pointer",letterSpacing:1,display:"flex",alignItems:"center",gap:6,margin:"14px auto 0" }}>
  ...
  if (screen === "chat") return (
    <div style={{ height:"100vh",background:`radial-gradient(ellipse at 20% 20%,${pal.b}22 0%,transparent 55%),radial-gradient(ellipse at 80% 80%,${pal.c}18 0%,transparent 55%),linear-gradient(160deg,#0d0d16,#12121e,#0f0f1a)`,display:"flex",flexDirection:"column",position:"relative",...lf }}>
      <style>{GF+"::-webkit-scrollbar{width:4px}::-webkit-scrollbar-thumb{background:rgba(255,255,255,0.1);border-radius:4px}"}</style>
      <div style={{ padding:"12px 16px",background:"rgba(13,13,22,0.85)",backdropFilter:"blur(24px)",WebkitBackdropFilter:"blur(24px)",borderBottom:`1px solid ${pal.b}22`,display:"flex",alignItems:"center",gap:10,boxShadow:`0 2px 24px rgba(0,0,0,0.5)` }}>
        ...
        <div style={{ flex:1 }}>
          <div style={{ ...pf,fontSize:16,color:"#f0eaf8",fontWeight:700 }}>{aiName}</div>
          <div style={{ fontSize:10,color:`${pal.b}cc` }}>{mode} · {emotion!=="neutral"?emotion:"listening"} {MOOD_EMOJI[emotion]}</div>
        </div>
  ...
  <IcoKey/>
      ...
      <div style={{ padding:"8px 14px",background:"rgba(13,13,22,0.7)",backdropFilter:"blur(12px)",WebkitBackdropFilter:"blur(12px)",borderBottom:`1px solid rgba(255,255,255,0.05)`,display:"flex",gap:6 }}>
        {MODES.map(m=>(
          <button key={m} onClick={()=>{setMode(m);lsSave("echo_mode",m);}} style={{ padding:"5px 14px",borderRadius:12,border:`1px solid ${mode===m?pal.b+"66":"rgba(255,255,255,0.07)"}`,background:mode===m?`${pal.b}28`:"rgba(255,255,255,0.04)",color:mode===m?pal.b:"rgba(240,234,248,0.4)",fontSize:11,cursor:"pointer",boxShadow:mode===m?`0 2px 12px ${pal.b}33`:"inset 0 1px 0 rgba(255,255,255,0.04)",transition:"all 0.2s" }}>{m}</button>
        ))}
      </div>
      <div ref={chatRef} onScroll={handleScroll} style={{ flex:1,overflowY:"auto",padding:"16px 12px",display:"flex",flexDirection:"column",gap:8,position:"relative" }}>
        {messages.map((msg,i)=>(
          ...
          >
            <div style={{ maxWidth:"78%",padding:"11px 15px",borderRadius:msg.f==="u"?"20px 20px 4px 20px":"20px 20px 20px 4px",background:msg.f==="u"?`linear-gradient(135deg,${pal.b}ee,${pal.c}cc)`:"rgba(255,255,255,0.05)",backdropFilter:msg.f==="e"?"blur(16px)":"none",WebkitBackdropFilter:msg.f==="e"?"blur(16px)":"none",color:"#f0eaf8",fontSize:14,lineHeight:1.65,boxShadow:msg.f==="u"?`0 4px 20px ${pal.b}55,inset 0 1px 0 rgba(255,255,255,0.2)`:`4px 4px 12px rgba(0,0,0,0.45),-1px -1px 6px rgba(255,255,255,0.03),inset 0 1px 0 rgba(255,255,255,0.06)`,border:msg.f==="e"?`1px solid rgba(255,255,255,0.08)`:"none",whiteSpace:"pre-line",position:"relative" }}>
              {!msg.sys && (
...
{msg.t && (() => {
  ...
  if (htmlMatch || isFullDoc || jsxMatch) {
    ...
    return (
      <div>
        ...
        <div style={{marginTop:8,background:"rgba(255,255,255,0.04)",borderRadius:12,overflow:"hidden",border:"1px solid rgba(255,255,255,0.08)"}}>
          <div style={{padding:"6px 12px",fontSize:10,color:"rgba(240,234,248,0.45)",letterSpacing:1,display:"flex",justifyContent:"space-between",alignItems:"center"}}>
    ...
    <div style={{ display:"flex",gap:6,flexWrap:"wrap",paddingBottom:4 }}>
      {pendingImages.map(img => (
        <div key={img.id} style={{ position:"relative" }}>
          <img src={img.preview} style={{ width:56,height:56,borderRadius:10,objectFit:"cover",border:"1.5px solid rgba(255,255,255,0.1)" }}/>
  ...
  <textarea
    ...
    rows={1}
    style={{ width:"100%",border:"none",outline:"none",background:"transparent",fontSize:14,color:"#f0eaf8",resize:"none",lineHeight:1.5,maxHeight:120,overflowY:"auto",fontFamily:"'Lato',sans-serif" }}
    onInput={e => {
  ...
  <div style={{ display:"flex",alignItems:"center",justifyContent:"space-between" }}>
    <button onClick={()=>setShowPlusMenu(v=>!v)} style={{ width:32,height:32,borderRadius:"50%",background:"none",border:"1.5px solid rgba(255,255,255,0.1)",cursor:"pointer",display:"flex",alignItems:"center",justifyContent:"center",flexShrink:0 }}>
      <IcoPlus/>
    </button>
    <div style={{ fontSize:10,color:"rgba(240,234,248,0.25)" }}>↵ send · shift+↵ newline</div>
    <button onClick={()=>send()} disabled={thinking||(!input.trim()&&!pendingImages.length)} style={{ width:36,height:36,borderRadius:"50%",background:thinking||(!input.trim()&&!pendingImages.length)?"rgba(255,255,255,0.08)":`linear-gradient(135deg,${pal.b},${pal.c})`,border:"none",cursor:thinking||(!input.trim()&&!pendingImages.length)?"default":"pointer",display:"flex",alignItems:"center",justifyContent:"center",color:"white",boxShadow:!thinking&&(input.trim()||pendingImages.length)?`0 2px 12px ${pal.b}44`:"none",transition:"all 0.2s",flexShrink:0 }}>
      ...
      {showPlusMenu && (
        <div style={{ position:"absolute",bottom:80,left:14,background:"rgba(15,15,26,0.94)",backdropFilter:"blur(24px)",WebkitBackdropFilter:"blur(24px)",borderRadius:16,border:"1px solid rgba(255,255,255,0.1)",boxShadow:`0 8px 40px rgba(0,0,0,0.7),inset 0 1px 0 rgba(255,255,255,0.06)`,padding:"8px 0",zIndex:20,minWidth:160 }}>
          <button onClick={startListening} style={{ display:"flex",alignItems:"center",gap:10,padding:"12px 18px",background:"none",border:"none",cursor:"pointer",width:"100%",color:"#f0eaf8",fontSize:14 }}>
          ...
          <button onClick={()=>imgInputRef.current?.click()} style={{ display:"flex",alignItems:"center",gap:10,padding:"12px 18px",background:"none",border:"none",cursor:"pointer",width:"100%",color:"#f0eaf8",fontSize:14 }}>
            <IcoImage/> Send Image
          </button>
        </div>
      )}
      ...
      <div style={{ padding:"10px 14px 14px",background:"rgba(13,13,22,0.88)",backdropFilter:"blur(20px)",WebkitBackdropFilter:"blur(20px)",borderTop:`1px solid rgba(255,255,255,0.06)` }}>
        <div style={{ background:"rgba(255,255,255,0.04)",borderRadius:20,border:"1px solid rgba(255,255,255,0.08)",boxShadow:"inset 0 2px 10px rgba(0,0,0,0.4),inset 0 -1px 0 rgba(255,255,255,0.04)",padding:"10px 14px",display:"flex",flexDirection:"column",gap:8 }}>
  {pendingImages.length > 0 && (
    <div style={{ display:"flex",gap:6,flexWrap:"wrap",paddingBottom:4 }}>
      {pendingImages.map(img => (
        <div key={img.id} style={{ position:"relative" }}>
  ...
  if (screen === "settings") return (
    <div style={{ height:"100vh",overflowY:"auto",background:`radial-gradient(ellipse at 20% 20%,${pal.b}22 0%,transparent 55%),linear-gradient(160deg,#0d0d16,#12121e)`,padding:24,...lf }}>
      <style>{GF}</style>
      <button onClick={()=>setScreen("home")} style={{ background:"none",border:"none",cursor:"pointer",display:"flex",alignItems:"center",gap:6,color:"rgba(240,234,248,0.5)",fontSize:14,marginBottom:20 }}><IcoBack/> Back</button>
      <h2 style={{ ...pf,fontSize:26,color:"#f0eaf8",marginBottom:4 }}>Settings</h2>
      <p style={{ fontSize:12,color:"rgba(240,234,248,0.45)",marginBottom:24 }}>Customize & train {aiName}</p>
      <div style={{ background:"#13131f",borderRadius:16,padding:18,marginBottom:14,border:"1px solid rgba(255,255,255,0.07)",boxShadow:"6px 6px 16px rgba(0,0,0,0.55),-3px -3px 10px rgba(255,255,255,0.03)" }}>
        <div style={{ fontSize:12,color:"rgba(240,234,248,0.4)",marginBottom:6,letterSpacing:1,textTransform:"uppercase" }}>AI Name</div>
        <p style={{ fontSize:11,color:"rgba(240,234,248,0.35)",marginBottom:10 }}>Rename {aiName} — she'll respond to it everywhere</p>
        <input defaultValue={aiName} onBlur={e=>{const v=e.target.value.trim()||"Echo";setAiName(v);lsSave("echo_name",v);}} placeholder="Echo" style={{ width:"100%",padding:"10px 14px",borderRadius:10,border:"1.5px solid rgba(255,255,255,0.1)",fontSize:14,color:"#f0eaf8",outline:"none",background:"rgba(255,255,255,0.06)" }}/>
      </div>
      <div style={{ background:"#13131f",borderRadius:16,padding:18,marginBottom:14,border:"1px solid rgba(255,255,255,0.07)",boxShadow:"6px 6px 16px rgba(0,0,0,0.55),-3px -3px 10px rgba(255,255,255,0.03)" }}>
        <div style={{ fontSize:12,color:"rgba(240,234,248,0.4)",marginBottom:10,letterSpacing:1,textTransform:"uppercase" }}>Personality Mode</div>
        <div style={{ display:"flex",gap:8 }}>
          {MODES.map(m=><button key={m} onClick={()=>{setMode(m);lsSave("echo_mode",m);}} style={{ flex:1,padding:"9px 0",borderRadius:10,border:`1.5px solid ${mode===m?pal.b+"66":"rgba(255,255,255,0.08)"}`,background:mode===m?`${pal.b}22`:"rgba(255,255,255,0.04)",color:mode===m?pal.b:"rgba(240,234,248,0.45)",fontSize:12,cursor:"pointer" }}>{m}</button>)}
        </div>
      </div>
      <div style={{ background:"#13131f",borderRadius:16,padding:18,marginBottom:14,border:"1px solid rgba(255,255,255,0.07)",boxShadow:"6px 6px 16px rgba(0,0,0,0.55),-3px -3px 10px rgba(255,255,255,0.03)",display:"flex",justifyContent:"space-between",alignItems:"center" }}>
        <div>
          <div style={{ fontSize:13,color:"#f0eaf8",fontWeight:"bold" }}>Voice (TTS)</div>
          <div style={{ fontSize:11,color:"#9a7e6a" }}>{aiName} speaks her responses</div>
        </div>
        <button onClick={()=>setTtsOn(v=>{lsSave("echo_tts",!v);return !v;})} style={{ padding:"8px 16px",borderRadius:12,border:`1.5px solid ${ttsOn?pal.b+"66":"rgba(255,255,255,0.08)"}`,background:ttsOn?`${pal.b}22`:"rgba(255,255,255,0.04)",color:ttsOn?pal.b:"rgba(240,234,248,0.45)",fontSize:12,cursor:"pointer" }}>{ttsOn?"On":"Off"}</button>
      </div>
      <div style={{ background:"#13131f",borderRadius:16,padding:18,marginBottom:14,border:"1px solid rgba(255,255,255,0.07)",boxShadow:"6px 6px 16px rgba(0,0,0,0.55),-3px -3px 10px rgba(255,255,255,0.03)" }}>
        <div style={{ fontSize:12,color:"rgba(240,234,248,0.4)",marginBottom:10,letterSpacing:1,textTransform:"uppercase" }}>🎨 Image Mode</div>
        <div style={{ display:"flex",gap:8,marginBottom:12 }}>
          {Object.keys(IMAGE_MODELS).map(m=>(
            <button key={m} onClick={()=>{setImgMode(m);lsSave("echo_imgmode",m);}}
              style={{ flex:1,padding:"9px 0",borderRadius:10,border:`1.5px solid ${imgMode===m?pal.b+"66":"rgba(255,255,255,0.08)"}`,background:imgMode===m?`${pal.b}22`:"rgba(255,255,255,0.04)",color:imgMode===m?pal.b:"rgba(240,234,248,0.45)",fontSize:12,cursor:"pointer" }}>
              {m}
            </button>
          ))}
        </div>
            ...
            <div style={{ display:"flex",gap:8,flexWrap:"wrap" }}>
              {Object.keys(IMAGE_MODELS_PRO).map(m=>(
                <button key={m} onClick={()=>{const val=imgProModel===m?null:m;setImgProModel(val);lsSave("echo_imgpromodel",val);}}
                  style={{ padding:"7px 12px",borderRadius:10,border:`1.5px solid ${imgProModel===m?"#70c498":"rgba(255,255,255,0.08)"}`,background:imgProModel===m?"#70c49822":"rgba(255,255,255,0.04)",color:imgProModel===m?"#70c498":"rgba(240,234,248,0.4)",fontSize:11,cursor:"pointer" }}>
                  {m}
                </button>
              ))}
            </div>
      ...
      <div style={{ background:"#13131f",borderRadius:16,padding:18,marginBottom:14,border:"1px solid rgba(255,255,255,0.07)",boxShadow:"6px 6px 16px rgba(0,0,0,0.55),-3px -3px 10px rgba(255,255,255,0.03)" }}>
        <div style={{ fontSize:12,color:"rgba(240,234,248,0.4)",marginBottom:6,letterSpacing:1,textTransform:"uppercase" }}>Memories ({memories.length})</div>
        <p style={{ fontSize:11,color:"rgba(240,234,248,0.35)",marginBottom:10 }}>Say "remember that..." or "forget..." in chat</p>
        {memories.length ? memories.map((m,i)=>(
          <div key={i} style={{ display:"flex",justifyContent:"space-between",alignItems:"center",padding:"6px 8px",background:"rgba(255,255,255,0.04)",borderRadius:8,marginBottom:4,fontSize:12,color:"rgba(240,234,248,0.7)" }}>
            <span>{m}</span>
      ...
      <div style={{ background:"#13131f",borderRadius:16,padding:18,marginBottom:14,border:"1px solid rgba(255,255,255,0.07)",boxShadow:"6px 6px 16px rgba(0,0,0,0.55),-3px -3px 10px rgba(255,255,255,0.03)",display:"flex",justifyContent:"space-between",alignItems:"center" }}>
        <div>
          <div style={{ fontSize:13,color:"#f0eaf8",fontWeight:"bold" }}>Chat History</div>
      ...
      <div style={{ background:"#13131f",borderRadius:16,padding:18,marginBottom:14,border:"1px solid rgba(255,255,255,0.07)",boxShadow:"6px 6px 16px rgba(0,0,0,0.55),-3px -3px 10px rgba(255,255,255,0.03)" }}>
        <div style={{ fontSize:12,color:"rgba(240,234,248,0.4)",marginBottom:10,letterSpacing:1,textTransform:"uppercase" }}>Train {aiName}</div>
        {!unlocked ? (
          <div>
            <p style={{ fontSize:13,color:"rgba(240,234,248,0.5)",marginBottom:10 }}>Enter developer password</p>
            ...
            <p style={{ fontSize:11,color:"rgba(196,168,212,0.6)",marginTop:8,textAlign:"center" }}>Default: luminar</p>
          </div>
        ) : (
          <div>
            ...
            <textarea value={resIn} onChange={e=>setResIn(e.target.value)} placeholder="Responses: Hey!|Hello!|Heyy!" rows={3} style={{ width:"100%",padding:"10px 14px",borderRadius:10,border:"1.5px solid rgba(255,255,255,0.1)",fontSize:13,color:"#f0eaf8",resize:"none",marginBottom:10,outline:"none",background:"rgba(255,255,255,0.06)" }}/>
            ...
            {trainLog.length>0&&(
              <div style={{ marginTop:14 }}>
                <button onClick={()=>setShowLog(v=>!v)} style={{ background:"none",border:"none",cursor:"pointer",fontSize:12,color:"rgba(240,234,248,0.4)",padding:0,marginBottom:8 }}>{showLog?"Hide":"View"} Log ({trainLog.length})</button>
                {showLog&&<div style={{ maxHeight:200,overflowY:"auto" }}>{[...trainLog].reverse().map((e,idx)=>(
                  <div key={e.id||idx} style={{ borderBottom:"1px solid rgba(255,255,255,0.05)",padding:"6px 4px",fontSize:11,color:"#9a7e6a",display:"flex",alignItems:"flex-start",justifyContent:"space-between",gap:8 }}>
                    <div style={{ flex:1 }}>
                      <span style={{ color:"#d4a856" }}>{e.triggers}</span>{" → "}{e.responses.split("|").map((r,j)=><span key={j} style={{ display:"inline-block",background:"rgba(255,255,255,0.06)",borderRadius:6,padding:"1px 6px",margin:"1px 2px",fontSize:10 }}>{r.trim()}</span>)}
                    </div>
      ...
      <div style={{ background:"#13131f",borderRadius:16,padding:18,marginBottom:14,border:"1px solid rgba(255,255,255,0.07)",boxShadow:"6px 6px 16px rgba(0,0,0,0.55),-3px -3px 10px rgba(255,255,255,0.03)" }}>
        ...
        <p style={{ fontSize:11,color:"rgba(240,234,248,0.35)",marginBottom:12 }}>Upload JSON training packs. Max 5MB.</p>
        <div style={{ marginBottom:14 }}>
          <div style={{ display:"flex",justifyContent:"space-between",fontSize:11,color:"rgba(240,234,248,0.4)",marginBottom:4 }}><span>Used: {storageKb}KB</span><span>Max: 5120KB</span></div>
        ...
        {packs.length ? packs.map((p,i)=>(
          <div key={p.id||i} style={{ display:"flex",alignItems:"center",justifyContent:"space-between",padding:"8px 10px",background:"rgba(255,255,255,0.04)",borderRadius:10,marginBottom:6 }}>
            <div>
              <div style={{ fontSize:12,color:"#3d2c1e" }}>{p.name}</div>
              <div style={{ fontSize:10,color:"rgba(240,234,248,0.4)" }}>{p.entries} entries · {p.size}</div>
            </div>
      ...
      <p style={{ textAlign:"center",fontSize:11,color:"rgba(240,234,248,0.2)",letterSpacing:2,marginTop:10,paddingBottom:20 }}>{aiName.toUpperCase()} BY LUMINAR INC</p>
    </div>
  );
  if (screen === "apikeys") {
    ...
    return (
      <div style={{ background:"#fdf6ee",borderRadius:14,padding:"12px 14px",marginBottom:10 }}>
        <div style={{ display:"flex",alignItems:"center",gap:8,marginBottom:8 }}>
          <div style={{ flex:1 }}>
            <div style={{ fontSize:13,fontWeight:700,color:"#f0eaf8" }}>{provider.label}</div>
  ...
  const SectionCard = ({ title, icon, accent, children }) => {
    ...
    return (
      <div style={{ background:"#13131f",borderRadius:18,marginBottom:14,border:"1px solid rgba(255,255,255,0.07)",overflow:"hidden",boxShadow:"6px 6px 16px rgba(0,0,0,0.55),-3px -3px 10px rgba(255,255,255,0.03)" }}>
        <button onClick={()=>setOpen(v=>!v)}
          ...
          <div style={{ flex:1,textAlign:"left" }}>
            <div style={{ fontSize:14,fontWeight:700,color:"#f0eaf8",...pf }}>{title}</div>
          </div>
  ...
  return (
    <div style={{ height:"100vh",overflowY:"auto",background:`radial-gradient(ellipse at 20% 20%,${pal.b}22 0%,transparent 55%),linear-gradient(160deg,#0d0d16,#12121e)`,padding:"24px 20px",...lf }}>
      <style>{GF}</style>
      <div style={{ display:"flex",alignItems:"center",gap:12,marginBottom:24 }}>
        ...
        <div>
          <h2 style={{ ...pf,fontSize:24,color:"#f0eaf8",margin:0 }}>API Hub</h2>
          <p style={{ fontSize:11,color:"rgba(240,234,248,0.4)",margin:0,letterSpacing:1 }}>BRING YOUR OWN KEY</p>
        </div>
      </div>
      {(chatActive || enhanceActive) && (
        <div style={{ background:`linear-gradient(135deg,${pal.b}18,${pal.c}14)`,borderRadius:14,
          ...
          {chatActive && <div style={{ fontSize:12,color:"rgba(240,234,248,0.8)",marginBottom:2 }}>Chat → {chatActive.label}</div>}
          {enhanceActive && <div style={{ fontSize:12,color:"rgba(240,234,248,0.8)" }}>Enhance → {enhanceActive.label}</div>}
        </div>
      )}
      <SectionCard title="Chat APIs" accent={pal.b} icon={
        ...
        <p style={{ fontSize:11,color:"rgba(240,234,248,0.35)",marginBottom:12,lineHeight:1.6 }}>One active at a time. Overrides Echo's default chat endpoint.</p>
        {CHAT_PROVIDERS.map(p=>(
         <KeyRow key={p.id} provider={p} cat="imagen" isRadio activeId={activeImagen} onToggle={toggleImagen}/>
        ))}
      </SectionCard>
      <SectionCard title="Image Generation APIs" accent="#70c498" icon={
        ...
        <p style={{ fontSize:11,color:"rgba(240,234,248,0.35)",marginBottom:12,lineHeight:1.6 }}>Keys auto-activate for their assigned mode when you generate images.</p>
        {IMAGEN_PROVIDERS.map(p=>(
          <KeyRow key={p.id} provider={p} cat="imagen" isRadio={false} activeId={null} onToggle={toggleImagen}
        ))}
        <div style={{ background:"rgba(255,255,255,0.04)",borderRadius:10,padding:"10px 12px",fontSize:11,color:"rgba(240,234,248,0.4)",lineHeight:1.6 }}>
      ...
      <SectionCard title="Image Enhancer APIs" accent="#c4a8d4" icon={
        ...
        <p style={{ fontSize:11,color:"rgba(240,234,248,0.35)",marginBottom:12,lineHeight:1.6 }}>Active when you tap Enhance in the + menu. One active at a time.</p>
        {ENHANCE_PROVIDERS.map(p=>(
          <KeyRow key={p.id} provider={p} cat="enhance" isRadio activeId={activeEnhance} onToggle={toggleEnhance}/>
        ))}
      </SectionCard>
      <p style={{ textAlign:"center",fontSize:10,color:"rgba(240,234,248,0.2)",letterSpacing:2,marginTop:8,paddingBottom:24 }}>
