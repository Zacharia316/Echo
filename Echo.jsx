...
if (screen === "settings") return (
    <div style={{ minHeight:"100vh", background:"linear-gradient(160deg,#fdf6ee,#f5e4f0)", padding:24, ...lato, overflowY:"auto" }}>
      <style>{gstyle}</style>
      <button onClick={() => setScreen(messages.length > 0 ? "chat" : "landing")} style={{ background:"none", border:"none", cursor:"pointer", display:"flex", alignItems:"center", gap:6, color:"#9a7e6a", fontSize:14, marginBottom:20 }}><BackIcon /> Back</button>
      ...
      <div style={{ background:"white", borderRadius:16, padding:18, marginBottom:14, border:"1px solid #f0e4d4" }}>
        ...
        <input defaultValue={aiName} onBlur={e => { const v = e.target.value.trim() || "Echo"; setAiName(v); localStorage.setItem("echo_ainame", v); }} placeholder="Echo" style={{ width:"100%", padding:"10px 14px", borderRadius:10, border:"1.5px solid #f0e4d4", fontSize:14, color:"#3d2c1e", outline:"none" }} />
      </div>
      ...
      <div style={{ background:"white", borderRadius:16, padding:18, marginBottom:14, border:"1px solid #f0e4d4" }}>
        <div style={{ fontSize:12, color:"#9a7e6a", marginBottom:6, letterSpacing:1, textTransform:"uppercase" }}>Learning Stats</div>
        <div style={{ display:"flex", gap:10 }}>
          <div style={{ flex:1, background:"#fdf6ee", borderRadius:10, padding:"10px 12px", textAlign:"center" }}>
            ...
            <div style={{ fontSize:10, color:"#9a7e6a" }}>Liked</div>
          </div>
          <div style={{ flex:1, background:"#fdf6ee", borderRadius:10, padding:"10px 12px", textAlign:"center" }}>
          ...
          <div style={{ flex:1, background:"#fdf6ee", borderRadius:10, padding:"10px 12px", textAlign:"center" }}>
            <div style={{ fontSize:20, fontWeight:"bold", color:"#e8a0b4" }}>{trainedData.length}</div>
            <div style={{ fontSize:10, color:"#9a7e6a" }}>Trained</div>
          </div>
        </div>
      </div>
